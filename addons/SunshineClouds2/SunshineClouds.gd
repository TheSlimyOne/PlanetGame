...
@export_range(0, 1) var atmospheric_density : float = 0.5
...
func update_matrices(camera_tr, view_proj):
	...
	general_data.encode_float(idx, cloud_ambient_color.r); idx += 4
	general_data.encode_float(idx, cloud_ambient_color.g); idx += 4
	general_data.encode_float(idx, cloud_ambient_color.b); idx += 4
	general_data.encode_float(idx, cloud_ambient_color.a); idx += 4
