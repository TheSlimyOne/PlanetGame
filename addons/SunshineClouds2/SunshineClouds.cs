...
public partial class SunshineClouds : CompositorEffect
{
    ...
    [Export(PropertyHint.Range, "0,1")] public float CloudsAnisotropy { get { return _cloudsAnisotropy; } set { _cloudsAnisotropy = value;  } }
...
        forwardA = forwardA.Normalized();
    ...
    private void UpdateMatricies(Transform3D cameraTR, Projection viewProj)
    {
        ...
        _generalDataFloats[idx++] = CloudAmbientColor.R;
        _generalDataFloats[idx++] = CloudAmbientColor.G;
        _generalDataFloats[idx++] = CloudAmbientColor.B;
        _generalDataFloats[idx++] = CloudAmbientColor.A;
