...
func retrieve_texture_data():
	...
	if clouds_resource != null:
		...
		elif tracked_directional_light_shadow_steps.size() > tracked_directional_lights.size():
			tracked_directional_light_shadow_steps.resize(tracked_directional_lights.size())
