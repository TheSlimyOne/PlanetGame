...
{
    public partial class CalculateSurfaceDispatcher : ComputeShaderDispatcher<CalculateSurfaceDispatcher.BufferNames>
    {
    	public PlanetController PlanetController { get; set; }
    	public CopyKeysDispatcher ComputeCopyShader { get; set; }
    	...
    	public CalculateSurfaceDispatcher(string shaderFilePath, ref RenderingDevice rd) : base(shaderFilePath, ref rd)
    	{
    		SetupComputeShader();
    	}
    	...
    	public override void CreateUniforms()
    	{
    		_computeShaderUniforms = new System.Collections.Generic.Dictionary<Enum, ComputeShaderUniform>()
    		{
    			...
    			[BufferNames.WRITE_CULLED_LIST] = new StorageBufferUniform(this, _rd, (int)BufferNames.WRITE_CULLED_LIST,
    				Utilities.ToBytes<Key>(new Key[PlanetController.PlanetData.MaximumNodes]).ToArray()
    			),
    			...
    			[BufferNames.KEYS] = new Texture2DUniform(this, _rd, (int)BufferNames.KEYS,
    				new RDTextureFormat()
    				{
    	...
    	public override void Ready()
    	{
    		...
    		_rd.ComputeListDispatchIndirect(computeList, ComputeCopyShader.GetUniformRid(CopyKeysDispatcher.BufferNames.DISPATCH_BUFFER), 0);
    		_rd.ComputeListEnd();
    	}
