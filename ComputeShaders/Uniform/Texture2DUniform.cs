...
namespace Uniform
{
	public partial class Texture2DUniform : ComputeShaderUniform
	{
		...
		public Texture2DUniform(IDispatchable owner, RenderingDevice renderingDevice, int binding, RDTextureFormat format, RenderingDevice.UniformType uniformType, List<byte[]> textureData = null, bool perserved = false) : base(renderingDevice, binding, owner, perserved)
		{
		...
		public Texture2DUniform(IDispatchable owner, RenderingDevice renderingDevice, int binding, RenderingDevice.UniformType uniformType, Image[] images, bool perserved = false) : base(renderingDevice, binding, owner, perserved)
		{
