...
public partial class ComputeGenerateNormals : ComputeShader<ComputeGenerateNormals.BufferNames>
{
    ...
    public override void CreateUniforms()
    {
        ...
        _computeShaderUniforms = new System.Collections.Generic.Dictionary<BufferNames, ComputeShaderUniform>()
        {
            ...
            [BufferNames.HEIGHT_MAP] =  ComputeCullShader.GetUniform(ComputeCullShader.BufferNames.HEIGHT_MAP),
            [BufferNames.HEIGHT_GRADIENT] = ComputeCullShader.GetUniform(ComputeCullShader.BufferNames.HEIGHT_GRADIENT),
